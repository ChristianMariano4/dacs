...
"""
───────────────────────────────────────────────────────────────
Trajectory Optimization Script for UAVs

This script performs trajectory fitting for UAV flight paths by 
using piecewise polynomial interpolation. It ensures smooth 
transitions between trajectory segments by enforcing continuity 
in position and its derivatives (up to order 3).

INPUT:  A CSV file of time-stamped waypoints (t, x, y, z, yaw)
OUTPUT: A trajectory file encoded as polynomial coefficients

REFERENCE: https://github.com/whoenig/uav_trajectories
───────────────────────────────────────────────────────────────
"""
