...
"""
───────────────────────────────────────────────────────────────
Trajectory Representation and Evaluation Module

This module provides classes for representing, manipulating, and
evaluating minimum-snap trajectories for quadrotors.
It supports:\n
- Piecewise polynomial trajectories (x, y, z, yaw)\n
- Derivative computation (vel, acc, jerk, snap)\n
- Roll, pitch, yaw, and angular velocity inference\n
- Time scaling (stretching)\n
- CSV loading/saving format compatible with uav_trajectories\n
