...
class LLMPlanner():
    ...
    def plan(self, task_description: str, scene_description: Optional[str] = None, error_message: Optional[str] = None, execution_history: Optional[str] = None, user_question_answer: Optional[str] = None):
